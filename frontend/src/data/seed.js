...
export const SEED = [
  {
    ...
    state: "draft", created: dateStr(dAgo(0)),
  ...
  },
  {
    ...
    state: "draft", created: dateStr(dAgo(1)),
  ...
  },
  {
    ...
    state: "inprocess", stage: "crawl", created: dateStr(dAgo(0)),
  ...
  },
  {
    ...
    state: "review", created: dateStr(D2),
  ...
  },
  {
    ...
    state: "review", created: dateStr(D3),
  ...
  },
  {
    ...
    runStartedAt: iso(D5), reviewReadyAt: iso(minLater(D5, 2.5)),
  ...
  },
  {
    ...
    runStartedAt: iso(D9), reviewReadyAt: iso(minLater(D9, 1.8)),
    focus: "", targets: [], notes: "",
    rules: [
  ...
  },
  {
    ...
    state: "review", created: dateStr(dAgo(4, 14, 0)),
  ...
  },
  {
    ...
    runStartedAt: iso(dAgo(6, 8, 30)), reviewReadyAt: iso(minLater(dAgo(6, 8, 30), 2.2)),
    focus: "", targets: [], notes: "",
    rules: [
  ...
  },
  {
    ...
    runStartedAt: iso(dAgo(7, 9, 0)), reviewReadyAt: iso(minLater(dAgo(7, 9, 0), 1.9)),
    focus: "", targets: [], notes: "",
    rules: [
  ...
  },
  {
    ...
    runStartedAt: iso(dAgo(8, 9, 20)), reviewReadyAt: iso(minLater(dAgo(8, 9, 20), 2.4)),
    focus: "", targets: [], notes: "",
    rules: [
  ...
  },
  {
    ...
    runStartedAt: iso(dAgo(10, 9, 0)), reviewReadyAt: iso(minLater(dAgo(10, 9, 0), 1.6)),
    focus: "", targets: [], notes: "",
    rules: [
  ...
  },
  {
    ...
    runStartedAt: iso(dAgo(11, 9, 0)), reviewReadyAt: iso(minLater(dAgo(11, 9, 0), 3.1)),
  ...
  },
  {
    ...
    runStartedAt: iso(dAgo(12, 10, 0)), reviewReadyAt: iso(minLater(dAgo(12, 10, 0), 2.0)),
    focus: "", targets: [], notes: "",
    rules: [
  ...
  },
  {
    ...
    runStartedAt: iso(dAgo(13, 9, 0)), reviewReadyAt: iso(minLater(dAgo(13, 9, 0), 2.6)),
    focus: "", targets: [], notes: "",
    rules: [
